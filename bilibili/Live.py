...
class LiveBiliBili(object):
    ...
    async def listen(self, live_room_address, message_handler, *args, live_room_id = None, alias = None):
        live_room_id = await Utils.auto_get_real_room_id(self.__async_loop, live_room_address, live_room_id = live_room_id)
        ...
        generator = LivePackageGenerator(loop = self.__async_loop)
